        ...
        <div class=" py-2 w-full">
            <div class="flex items-center justify-between">
                <div class="flex items-center text-white">
                    <img alt="post" class="rounded-full h-[35px]" :src="post.image">
            ...
            <div class="relative flex items-center w-full">
                ...
                <div class="bg-black rounded-lg w-[calc(100%-50px)] text-sm w-full font-light">
                    ...
                    <img v-if="post && post.picture" class="mx-auto w-full mt-2 pr-2 rounded"
                        :src="runtimeConfig.public.bucketUrl + post.picture" alt="post-picture" />
            ...
            <div class="flex items-center">
                <div class="flex items-center flex-wrap text-white gap-1 w-[42px]">
                    <div class="flex gap-0.5">
                        <img class="rounded-full h-[14px] mt-2" src="https://picsum.photos/id/202/50" alt="test">
                        <img class="rounded-full h-[17px]" src="https://picsum.photos/id/223/50" alt="test2">
                    </div>
                    <div class="flex items-center">
                        <img class="rounded-full h-[11px] ml-4" src="https://picsum.photos/id/99/50" alt="test3">
                    </div>
                </div>
            </div>
        </div>
